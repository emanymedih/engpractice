const CACHE='wordmemo-v11.1.1-2026-07-24';
const CORE=['./','./index.html','./app-core.html','./v11.css?v=11.1.0','./v11.js?v=11.1.0','./v11.1-fixes.js?v=11.1.0','./diagnostics.html','./manifest.webmanifest','./icons/icon-180.png','./icons/icon-192.png','./icons/icon-512.png'];
